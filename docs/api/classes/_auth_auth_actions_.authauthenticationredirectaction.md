[API](../README.md) > ["auth/auth.actions"](../modules/_auth_auth_actions_.md) > [AuthAuthenticationRedirectAction](../classes/_auth_auth_actions_.authauthenticationredirectaction.md)
